...
# DENSE NETWORK
a,g,b,r = gh.create_h(2500,128,128,6,1,5)

# local histograms
autoenc_a, a_train, a_test = m.auto_encoder(0,1,0,128,128,6,2048,128,a,g,b,r)

# global histograms
autoenc_g, g_train, g_test = m.auto_encoder(0,0,1,128,128,6,2048,128,a,g,b,r)
